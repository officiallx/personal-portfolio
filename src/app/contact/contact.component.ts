...
export class ContactComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    jQuery(document).ready(function($) {
      ...
      let keyDownSound : HTMLVideoElement = <HTMLVideoElement>document.getElementById('keydown');
      let keyUpSound : HTMLVideoElement = <HTMLVideoElement>document.getElementById('keyup');
